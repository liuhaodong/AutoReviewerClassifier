...
dataset='Abalone';  % the following UCI datasets are also included in the package
...
ClassifierTypes= [1 1 3] ;   % Identify base classifiers: 1=MLP 2=KNN 3=LIBSVM
Params.MLP.Fnc='logsig';     % Function (purelin, tansig, hardlim,logsig)
...
Pmethod='Kfold'; N_folds=9;  % Partitioning (evaluation) method is either "Holdout" or "Kfold"
